...
<div class="row" style="margin-top: -13px;">
    ...
    <tr>
        ...
        <td style="width: 240px;">
            ${freeBoard.boardTitle }<span class="text-danger">(${totalRecord}/${freeBoard.boardReadcount})</span>
        </td>
        <th>작성자</th>
        ...
        <td>
            <div class="row">
                <%-- 로그인 계정(loginUser)와 작성자(empNo)를 비교하여 게시글 수정/삭제 버튼을 노출시키지 않음, 관리자는 모든 글에 대한 수정/삭제 권한을 가짐 --%>
                <c:choose>
                    <c:when test="${loginUser.empNo ne freeBoard.empNo and loginUser.empNo ne 'admin01' }">
                        <%-- 로그인 계정(loginUser)와 작성자(empNo)가 다를 경우 수정, 삭제 버튼 노출 --%>
                        ...
                        <table style="text-align: right; margin-top: 1px;">
                            <tr>
                                <td>
                                    ...
                                    <button class="btn btn-success freeUpdateBtn" data-ucode="${freeBoard.boardNo }">
                                        <i class="icofont-edit" style="size: 100px;"></i>&nbsp;
                                        <!-- 게시글 Edit -->
                                    </button>
                                    <button type="button" class="btn btn-danger freeDeleteBtn" style="margin-right: 33px;" data-fdcode="${freeBoard.boardNo }">
                ...
                <!-- 로그인 계정(loginUser)와 작성자(empNo)를 비교하여 게시글 수정/삭제 버튼 노출 결정 -->
            </div>
        </td>
    </tr>
</table>
...
<div class="tab-content" id="myTabsContent">
    ...
    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
       ...
       <!--첨부파일이 있을 경우 본문과 첨부파일 영역을 2개로 분할하여 출력  -->
