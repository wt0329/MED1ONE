					...
					<div class="col-md-4 col-lg-4" style="width: 50%; height: 95%; ">
						<div class="card top-color" style="height: 850px; margin-right: 2%; ">
					        <div class="d-flex justify-content-end" style="margin-top:5px; margin-right:5px;">
		                        <button class="btn btn-secondary" type="button" id="dataInput" style="margin-right: 10px;">click</button>
...
$(document).ready(function() {
	...
	$("#dataInput").on("click",function(){
		$("#textInput").text("고형결절발견해, 폐암가능성 있음. 빠른시일내에 내원하여 검사바람");
	});
        ...
        success: function(data) {
            ...
            $.each(data, function(index, list) {
                if (list.statCode === '017') {
                    ...
                    row.append('<td style="color: red">진료 대기</td>');
					row.data('rec-code', list.recCode);   
					row.data('patnt-nm', list.recep.patnt.patntNm);   
                    
                    row.append('<td ><button type="button" class="saveABtn mint-btn">완료</button></td>');
                    tbody.append(row);
                }
            });
        },
			...
			success: function(data){
				var tableHTML = `
					...
					<tr height=195 style='mso-height-source: userset; height: 116.25pt'>
						...
						<td colspan=6 class=xl1281482
							style='border-right: .5pt solid black; border-left: none'><textarea id="textInput" style="width: 470px; height: 150px; font-size:15px;"></textarea></td>
					</tr>
