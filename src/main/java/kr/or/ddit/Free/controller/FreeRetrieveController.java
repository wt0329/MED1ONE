...
public class FreeRetrieveController {
	...
	public String boardView(
		...
		model.addAttribute("boardList", freeBoardList); // 이전글, 다음글 조회 정보
		model.addAttribute("freeBoard", freeBoard); // 해당 게시물 상세조회용
		model.addAttribute("cmtPaging", cmtPaging);// 댓글 목록
		model.addAttribute("totalRecord", totalRecord);// 게시물 조회수 정보
