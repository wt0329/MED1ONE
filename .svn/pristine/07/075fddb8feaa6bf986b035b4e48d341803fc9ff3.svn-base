...
<!-- main body area -->
<div class="main px-lg-4 px-md-4" style="margin-top: -10px">
	<!-- Body: Body -->
				...
				<div class="col-sm-12">
					<div class="card mb-3 top-color">
						<div class="card-body">
							...
							<div id="overflow" style="overflow: auto; width: 1490px; height: 308px;">
						...
						<div class="card-body" style="margin-top: -58px">
							<div >
								<table class="table table-hover align-middle mb-0"
									...
									<div id="overflow" style="height: 275px; width: 1442px; overflow-y: scroll;">
									<table class="table table-hover align-middle mb-0">
