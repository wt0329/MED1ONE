													...
													<table class="table table-hover align-middle mb-0"
														...
														<thead>
															<tr style="border-bottom: 1px solid black;">
				                                                ...
				                                                <th style="width:106px; padding-left: 20px;" id="patntNm">성명</th>
				                                                <th style="width:138px;" id="patntIdentino">주민번호</th>
				                                                <th style="width:67px; text-align: center;" id="height">키</th>
				                                                <th style="width:93px; text-align: center;" id="weight">몸무게</th>
				                                                <th style="width:111px; text-align: right;" id="patntTelno">전화번호</th>
				                                                <th style="width:171px; text-align: center;" id="patntZipcode">우편번호</th>
				                                                <th style="width:253px;" id="patntAddr1">주소</th>
				                                                <th style="width:111px;" id="patntAddr2">상세주소</th>
	...
	$.getJSON("<c:url value='/administ/patientSearch.do' />",{patntNm:patntNm }).done(function(resp) {
		...
		if (resp.length > 0) {$(resp).each(function(idx,patientList) {
			let tr = $("<tr>").append(
				...
				$("<td>").html(patientList.patntNm).css({
