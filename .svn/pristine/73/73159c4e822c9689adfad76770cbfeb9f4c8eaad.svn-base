...
<div class="main px-lg-2 px-md-1">
			...
			<div class="row clearfix g-3">
				<div class="col-sm-12">
					<div class="card mb-3 top-color">
						<div class="card-body">
							<div id="overflow" style="height: 300px; width: 1525px; overflow-y: scroll;">
	...
	<div class="row align-items-center">
		<div class="border-0 mb-3">
			<div
				class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap" style=" margin-top:-27px">
	...
	<div class="row clearfix g-3">
		<div class="col-sm-12">
			<div class="card mb-3 top-color">
				<div class="card-body">
					<div id="overflow" style="height: 322px; width: 1525px; overflow-y: scroll;">
